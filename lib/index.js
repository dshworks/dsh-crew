...
export const Config = z.object({
  ...
  /**
   * Expose `crew_send`'s `run_in_background` (default true); a call that forces
   * it anyway is also rejected. It needs the harness's job seam — `ctx.jobs`
   * plus a job controller the calling agent can reach — and says so if it is
   * missing.
   */
